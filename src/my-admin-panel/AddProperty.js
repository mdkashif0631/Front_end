    ...
    switch (step) {
      ...
      case 2:
        return (
          <div>
            <label>Id :</label>
            <input placeholder='Enter Id' type="text" name="Id" onChange={handleChange} value={formData.Id} />
            ...
            <label>Our Company Logo:</label>
            <input placeholder='Enter ' type="file" name="Logoimg" onChange={handleChange} />
            <label>Project Description:</label>
            <input placeholder='Enter ' type="text" name="Description" onChange={handleChange} value={formData.Description} />
            <label>Developer Rera Number:</label>
            <input placeholder='Enter ' type="text" name="Developer_Rera_No" onChange={handleChange} value={formData.Developer_Rera_No} />
            <label>Our Rera Number:</label>
            <input placeholder='Enter ' type="text" name="Our_Rera_Number" onChange={handleChange} value={formData.Our_Rera_Number} />
          </div>
        );
      case 3:
        return (
        ...
        return (
          <div>
            ...
            {Object.entries(featuresByCategory).map(([category, features]) => (
              <div key={category}>
                <h4><span>{iconMap[category] || "✅"}</span> {category}</h4>
