...
const LuxuryCommercial = () => {
    const [chunked, setChunked] = useState([]);

    useEffect(() => {
        fetch(`${BASE_URL}/commercialproperties`) // Update if backend URL changes
            .then(res => res.json())
            .then(data => {
        ...
        <div className='project-container'>
            <div className='project-box'>
                <div className='project-header'>
                    <h2>Luxury Commercial Property</h2>
                </div>
...
export default LuxuryCommercial;